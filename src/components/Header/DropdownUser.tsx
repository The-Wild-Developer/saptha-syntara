  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-gradient-to-tr from-primary to-hover">
          <User className="h-6.5 w-6.5 text-white dark:text-white" />
        </span>
      </Link>
