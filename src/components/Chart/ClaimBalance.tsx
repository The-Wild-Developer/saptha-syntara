    ...
    if (typeof window !== "undefined") {
      import("apexcharts").then((ApexCharts) => {
        ...
        if (chartElement && !chartElement.getAttribute("data-initialized")) {
          ...
          const hover =
            styles.getPropertyValue("--color-hover").trim() || "#2563EB";
  ...
  return (
    <div className="h-full w-full rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
      ...
      <div className="mb-2 grid grid-cols-2 gap-3">
        <dl className="flex h-[78px] flex-col items-center justify-center rounded-lg bg-primary/10 dark:bg-gray-600">
          <dt className="mb-1 flex items-center justify-center text-sm font-medium text-primary">
            LKR 10,000.00
          </dt>
